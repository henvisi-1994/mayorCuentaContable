...
class DET_DIARIODETController extends Controller
{
    public function mayorCuentaContable(Request $request)
    {
        ...
        Where  tp.CC_NIVEL2 = " .  $nivel2 . " AND tp.CC_NIVEL3 = " . $nivel3 . " AND tp.CC_NIVEL4 = '" . $nivel4 . "'AND  tp.CC_NIVEL5 = '" . $nivel5 . "' AND tp.CC_NIVEL6 = ' ' AND tp.CC_AUXILIAR='" . $auxiliar . "'  AND dd.CC_FECMOV  BETWEEN '" . $fecha_inicio . " '   AND  '" . $fecha_fin . "'";
